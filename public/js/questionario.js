        ...
        resultados.innerHTML = `
            <div class="card">
                <div id="pontuacaoFinalJogo">
                    <span id="pontuacaoFinal">PONTUAÇÃO FINAL:  <span style="color: black;" id="spanPontuacaoFinal">${pontuacaoFinal * 7}</span></span>
                </div>
                <div class="btns">
    ...
    function obterDadosRanking() {
        fetch(`/questionario/ranking`, { cache: 'no-store' }).then(function (response) {
            if (response.ok) {
